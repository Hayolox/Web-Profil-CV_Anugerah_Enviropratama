      ...
      <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
          <ul>
            ...
            <li class="dropdown">
              <a class="{{ request()->is('Profil*') ? 'active' : '' }}" href="#"><span>Profil</span> <i class="bi bi-chevron-down"></i></a>
              <ul>
            ...
            <li><a class="nav-link scrollto {{ request()->is('Berita*') ? ' active' : ''}}" href="{{ route('berita') }}">Berita</a></li>
